...
- **Ator Principal:** identifica o ator que mais interage com o caso de uso.
- **Atores Secundários:** interagem em um nível menor com o sado de uso. (Não é obrigatório declarar um ator secundário, visto que pode existir ou não).
...
- **Pré-condições:** para que o caso de uso seja executado ou concluído.
- **Pós-condições:** tarefas que devem ser realizadas depois que as etapas do caso de uso tiverem sido concluídas.
